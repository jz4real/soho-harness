...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Optional draft attachment cards, drop target, and image-preview surface inside the composer.',
    doc: 'Optional draft attachment cards, drop target, and image-preview surface inside the composer.',
    registerOptions: [],
    ownerProps: [
