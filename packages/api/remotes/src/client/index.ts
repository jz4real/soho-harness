...
import skillLibraryRemote from '@deepseek-ai/dsh-host-skill-library/remote'
...
export type { SkillImportPreview, SkillLibraryEntry } from '@deepseek-ai/dsh-host-skill-library/types'
export type {} from '@deepseek-ai/dsh-commands/remote'
export type {} from '@deepseek-ai/dsh-file-reference/remote'
export type {} from '@deepseek-ai/dsh-goal/remote'
export type {} from '@deepseek-ai/dsh-host-plugin-inventory/remote'
export type {} from '@deepseek-ai/dsh-host-skill-library/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, skillLibraryRemote, messageFeedbackRemote, sessionReferencesRemote,
    ]) {
